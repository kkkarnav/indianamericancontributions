...
pac_party_mapping = {
    "Obama Victory Fund": "D",
    "Biden Victory Fund": "D",
    "Hillary Victory Fund": "D",
    "ActBlue": "D",
    "Democratic Senatorial Campaign Cmte": "D",
    "Democratic Congressional Campaign Cmte": "D",
    "Michigan Democratic State Central Cmte": "D",
    ...
    "Fair Fight PAC": "D",
    "Democratic Action": "D",
    "National Democratic Training Cmte": "D",
    "Committee for Hispanic Causes-BOLD PAC": "D",
...
for year in tqdm(["00", "02", "04", "06", "08", 10, 12, 14, 16, 18, 20, 22]):
    ...
    yearly_recip_df.loc[yearly_recip_df["name_y"].str.contains("Democrat", case=False, na=False), "party"] = "D"
    yearly_recip_df.loc[yearly_recip_df["name_y"].str.contains("Republican", case=False, na=False), "party"] = "R"
    yearly_recip_df.loc[yearly_recip_df["name_y"].str.contains("Progressive", case=False, na=False), "party"] = "D"
    yearly_recip_df.loc[yearly_recip_df["name_y"].str.contains("Conservative", case=False, na=False), "party"] = "R"
